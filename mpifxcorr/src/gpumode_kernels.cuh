...
void gpu_complexrotatorMultiply(const size_t fftchannels, cuFloatComplex *const
    a, const double bigA, const double bigB, cuFloatComplex *comparison);
//void gpu_complexrotatorMultiply(const size_t len, cuComplex *const a, const double bigA, const double bigB, const cuComplex *const original_cr);
